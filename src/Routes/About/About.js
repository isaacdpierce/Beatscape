...
const About = () => (
  <TextBlock>
    ...
    <p>
      Because you need perfect control over your atmosphere so you can optimize
      focus and productivity.
    </p>
    <p>
      Because listening to an 8 hour live YouTube feed of someone playing
      unrelated tracks can be distracting and break concentration. Maximum focus
      comes from removing distractions.
    </p>

    <p>
      How many times have you been listening to music that was great background
      for a while then suddenly the song changes? Or an irritating sound comes
      into an otherwise great song. Beatscape give you the power.'
    </p>
    <p>
    ...
    <div>
      The web designs and code composition are done by the dishonorable and very
      irrelevant
